            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <Link
                  ...
                  class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-blue dark:hover:bg-gray-700 group"
                >
                  <span class="tracking-widest mx-auto text-2xl font-bold">
                    G.N.K SCHOOL
                  </span>
                </Link>
              </li>
              ...
              <li>
                <Link to="/adminresults" onClick={closeAllDropdowns} class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-blue dark:hover:bg-gray-700 group">
              ...
              <li>
                <Link to="/uploadrequitment" onClick={closeAllDropdowns} class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-blue dark:hover:bg-gray-700 group">
                  <svg class="w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                    <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path> </svg>
                  <span class="ms-3">Recuitment</span>
                </Link>
              </li>
              ...
              <li className="relative">
                ...
                >
                  ...
                  <span class="ms-3">Admission Form</span>
                  <ChevronDownIcon
              ...
              <li className="relative">
                ...
                >
                  ...
                  <Link class="ms-3" to="/delete_mangement">
                    Management
                  </Link>{" "}
                </button>
              </li>
              ...
              <li className="relative">
                ...
                >
                  ...
                  <Link class="ms-3" to="/faculties-info">
                    Faculties
                  </Link>
                </button>
              </li>
              ...
              <li>
                <Link to="/deletenews" onClick={closeAllDropdowns} class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-blue dark:hover:bg-gray-700 group">
                  <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                   ...
                   <span class="ms-3">News & Highlights</span>
                </Link>
              </li>
