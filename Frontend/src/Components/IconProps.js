...
export default function IconsProps() {
    ...
    return (
        <ul className="h-[219px]  z-50  fixed top-[40%] left-[86%] 2xl:left-[97%] xl:left-[96%] lg:left-[95%] md:left-[94%] sm:left-[92%] xs:left-[89%] w-full  xl:w-[60%] lg:w-[62%] md:w-[63%] sm:w-[80%]  h-full " >
            ...
            <Link target="_blank" to='https://www.youtube.com/@GuruNanakKhalsa-30b'><li className="w-full shadow-lg text-2xl left-0 text-white mb-1 bg-red-500 px-1 py-1 relative  w-1/4 duration-300  hover:left-[-38%] xs:hover:left-[-26%]"><i className="fa fa-youtube  mx-5 inline" />YouTube </li></Link>
