        ...
        <div className="mx-auto lg:flex justify-between lg:px-4 px-2">
          <div className="lg:w-1/2 w-full lg:flex justify-between px-4">
            <div className="lg:w-1/2 flex justify-between px-4">
                <div>              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              ...
              <p className="mt-2 leading-7 text-justify text-white">
                ...
                aided institute of a rich reputation. School was established on
                the auspicious day of Baisakhi 13th April, 1965 and successfully
                completed 50 years.
              </p></div>
          ...
          <div className="lg:w-1/2 lg:flex justify-between px-4">
            <div className="lg:w-1/2 flex justify-between px-4">
                <div>              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <MapIcon
