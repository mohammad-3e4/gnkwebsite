    ...
    return (
        ...
        <div className="my-3 p-3">
            <div className="p-3 w-full  text-center ">
                <h4 style={{ color: 'var(--orange)'}} className="font-bold text-xl">RECRUITMENT NOTICE FOR APPOINTMENT OF UNAIDED TEACHING AND NON TEACHING STAFF</h4>
                <br></br><p>TGT Mathematics -1</p>
                <p>TGT SST - 1</p>
                <br></br><h4 className="font-bold text-xl">Primary Teacher - 2</h4>
                <br></br><p>Clerk - 1</p>
